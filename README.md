...
- Repository: https://github.com/kadubon/github.io
...
- Use GitHub's **Cite this repository** feature.
- Or use metadata in `CITATION.cff` directly.
- The citation metadata includes both the home page and the works page URL.
